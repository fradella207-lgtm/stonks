...
import { FileSpreadsheet, UploadCloud, X, Sparkles, ArrowRight } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-2.5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono-code text-[10px] uppercase tracking-widest text-emerald-400 font-bold flex items-center gap-1.5">
            ...
            <span>Nuovo Account Creato • Spazio Pronto</span>
          </span>
        </div>
      ...
      <div className="space-y-1.5 mb-3.5">
        <h3 className="font-mono-code text-sm sm:text-base font-bold text-app-main tracking-tight">
          Vuoi importare il tuo vecchio file di spese?
        </h3>
        <p className="text-xs text-app-muted leading-relaxed font-mono-code">
          Il tuo nuovo account è pulito e senza dati. Se prima tenevi traccia delle tue entrate e uscite
          su un foglio Excel, CSV, JSON o su <strong>Google Fogli</strong>, puoi caricarlo subito per ritrovare
          tutti i tuoi movimenti qui!
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-1">
        ...
        >
          ...
          <span>Importa File Precedente</span>

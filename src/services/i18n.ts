...
export const translations = {
  it: {
    ...
    comment_optimal: 'Stai gestendo alla perfezione il tuo budget di {budget}: spesi {spent} ({percent}%), con un margine residuo di {remaining} ({dailyRemaining}/giorno per i restanti {daysRemaining} giorni).',
    comment_balanced: 'Budget di {budget} sotto controllo: uscite a quota {spent} ({percent}%). Restano ancora {remaining} a disposizione ({dailyRemaining}/giorno).',
